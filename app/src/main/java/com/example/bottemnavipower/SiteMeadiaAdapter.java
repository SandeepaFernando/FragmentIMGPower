...
public class SiteMeadiaAdapter extends RecyclerView.Adapter<SiteMeadiaAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public SiteMeadiaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.image_item, parent, false);
        return new SiteMeadiaAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SiteMeadiaAdapter.ViewHolder holder, final int position) {
